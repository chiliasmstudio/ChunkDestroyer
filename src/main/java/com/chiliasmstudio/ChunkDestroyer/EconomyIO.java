...
public class EconomyIO {
    ...
    public EconomyIO(ChunkDestroyer chunkDestroyer){
        RegisteredServiceProvider<Economy> economyProvider = chunkDestroyer.getServer().getServicesManager().getRegistration(Economy.class);
        if (economyProvider != null) {
            econ = economyProvider.getProvider();
        }else chunkDestroyer.getComponentLogger().error(
